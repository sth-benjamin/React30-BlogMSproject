...
const Form = ({type}) => {
  return (
    <div><div class="lg:min-h-screen flex fle-col items-center justify-center p-6">
      <div class="grid lg:grid-cols-2 items-center gap-10 max-w-6xl max-lg:max-w-lg w-full">
        <div>
          <h1 class="lg:text-5xl text-4xl font-bold text-slate-900 !leading-tight"> 
            {type === 'Register' ? 'Login here to continue': 'Register your account now'}
          </h1>
          ...
          {/* <p class="text-[15px] mt-6 lg:mt-12 text-slate-600">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-medium hover:underline ml-1">Register here</a></p> */}
        </div>
        ...
        <form class="max-w-md lg:ml-auto w-full">
          ...
          <div class="space-y-6">
            ...
            </div>
            {
              ...
              <input name="username" type="username" required class="bg-slate-100 w-full text-sm text-slate-900 px-4 py-3 rounded-md outline-0 border border-gray-200 focus:border-blue-600 focus:bg-transparent" placeholder="Enter Email" />
            </div>
            )
            }
            <div>
