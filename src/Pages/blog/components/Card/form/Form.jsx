...
const Form = ({type}) => {
  return (
	...
	<div className="container my-3 px-4 lg:px-20 ">
		...
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl mt-3 mx-50">
			<div className="flex">
            ...
            type="number" placeholder="Category*" />
				...
				<div className="my-4">
					<textarea placeholder="Discription*" className="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
				</div>
